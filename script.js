...
const sections = [
  ...
  {
    id: 'recommendations', // New: Recommendations section!
    text: '- LINKEDIN RECOMMENDATIONS -', // Add dashes for consistency
    speed: 100,
    played: false,
    element: null
  }
    ...
    entries.forEach(entry => {
      if (entry.isIntersecting && !played) {
        skillCells.forEach((cell, idx) => {
          ...
          }, idx * 80); // 80ms stagger per cell
        });
        played = true;
      }
    });
  }, {
    threshold: 0.22 // Adjust if you want it to start sooner/later
  });
...
// Smooth scroll for in-page anchor links (e.g., #linkedinrecommendations)
